...
function TimeGiver({ //TimeGiver is the main function of the script that takes arguments about rhythm parameters using key-value syntax with defaults as shown below and returns a list of 8 items describing how the lights should look at that moment according to that schedule.
    time = null, //time is a simulated time variable that overrides real current time if it is set to greater than or equal to 1, and it is only intended to be used for testing purposes
    ...
    if (rise_length_bright === null) {var rise_length_bright = half_day_length} else {var rise_length_bright = rise_length_bright};
    if (set_length_bright === null) {var set_length_bright = half_day_length} else {var set_length_bright = set_length_bright};
    if (rise_length_CCT === null) {var rise_length_CCT = half_day_length} else {var rise_length_CCT = rise_length_CCT};
    if (set_length_CCT === null) {var set_length_CCT = half_day_length} else {var set_length_CCT = set_length_CCT};
    if (rise_length_scatdist === null) {var rise_length_scatdist = half_day_length} else {var rise_length_scatdist = rise_length_scatdist};
    if (set_length_scatdist === null) {var set_length_scatdist = half_day_length} else {var set_length_scatdist = set_length_scatdist};
    if (rise_length_scatangshift === null) {var rise_length_scatangshift = half_day_length} else {var rise_length_scatangshift = rise_length_scatangshift};
    if (set_length_scatangshift === null) {var set_length_scatangshift = half_day_length} else {var set_length_scatangshift = set_length_scatangshift};
    if (rise_length_bright_yellow === null) {var rise_length_bright_yellow = half_day_length} else {var rise_length_bright_yellow = rise_length_bright_yellow};
    if (set_length_bright_yellow === null) {var set_length_bright_yellow = half_day_length} else {var set_length_bright_yellow = set_length_bright_yellow};
    if (rise_length_bright_blue === null) {var rise_length_bright_blue = half_day_length} else {var rise_length_bright_blue = rise_length_bright_blue};
    if (set_length_bright_blue === null) {var set_length_bright_blue = half_day_length} else {var set_length_bright_blue = set_length_bright_blue};
