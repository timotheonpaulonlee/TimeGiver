...
function TimeGiver({ //The meaning and use of these arguments is explained at length in the TimeGiver documentation.
    ...
    min_sun_rad = 25,
    range_sun_rad = 20,
    rise_max_bright_blue_alt = 17.5,
    rise_min_bright_blue_alt = 2.5,
    rise_max_bright_yellow_alt = 15,
    rise_min_bright_yellow_alt = 5,
    ...
    if (time !== null) {var hm = time; //This conditional statement allows users to pass a simulated time variable that will override the real current time for all times greater than or equal to 1
      ...
      var hh = ((hm/60) - (hm % 60)); //sets the variable hh equal to the number of hours that have passed since the day started.
      var day = now.getDate();
      var mon = now.getMonth();
      var yr = now.getFullYear(); //sets the variable yr equal to the full year.
      var daysbeforemon = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365];
      var daysbeforemon_lp = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366];
      if ((yr % 4) > 0) {var yr_length = 365; var days_total = (daysbeforemon[mon] + day)} else if (((yr % 4) == 0) && ((yr % 400) > 0)) {var yr_length = 366 ; var days_total = (daysbeforemon_lp[mon] + day)} else if (((yr % 400) == 0)) {var yr_length = 365; var days_total = (daysbeforemon[mon] + day)}
      var yr_frac = (((2 * 3.1415926535897932384626433)/yr_length) * (days_total - 1 + ((hh)/24)))
      var eq_time = (229.18 * ((0.000075) + (0.001868 * Math.cos (yr_frac)) - (0.032077 * Math.sin (yr_frac)) - (0.014615 * Math.cos (2 * yr_frac)) - (0.040849 * Math.sin (2 * yr_frac))))
      var decl = ((0.006918) - (0.399912 * Math.cos (yr_frac)) + (0.070257 * Math.sin (yr_frac)) - (0.006758 * Math.cos (2 * yr_frac)) + (0.000907 * Math.sin (2 * yr_frac)) - (0.002697 * Math.cos (3 * yr_frac)) + (0.00148 * Math.sin (3 * yr_frac)))
    ...
    var alt_dist = Math.abs (altitude - sun_altitude)
    if ((Math.abs (azimuth - sun_azimuth)) <= 180) {var az_dist_rad = degreestoradians (Math.abs (azimuth - sun_azimuth));} else {var az_dist_rad = degreestoradians (360 - (Math.abs (azimuth - sun_azimuth)));}
    var sun_dist = radianstodegrees (Math.acos ((Math.cos (alt_diff_rad) * Math.cos (sun_alt_diff_rad)) + (Math.sin (alt_diff_rad) * Math.sin (sun_alt_diff_rad) * Math.cos(az_dist_rad))))
    ...
    /*if (sun_azimuth <= 180) {
      if (sun_altitude > rise_max_bright_blue_alt) {bright_blue_int = Math.round((max_bright_blue) * 254)} else if (sun_altitude <= rise_max_bright_blue_alt && sun_altitude > (((rise_max_bright_blue_alt - rise_min_bright_blue_alt)/2)+rise_min_bright_blue_alt)) {
        ...
        var range_bright_blue = (max_bright_blue2 - min_bright_blue2)
        var bright_blue_int = Math.round((max_bright_blue2 - ((sun_dist/180) * range_bright_blue)) * 254)} else if (sun_altitude <= (((rise_max_bright_blue_alt - rise_min_bright_blue_alt)/2)+rise_min_bright_blue_alt) && sun_altitude > rise_min_bright_blue_alt) {

        var min_bright_blue3 = ((((sun_altitude - rise_min_bright_blue_alt)/(rise_max_bright_blue_alt-rise_min_bright_blue_alt)) * (max_bright_blue - min_bright_blue)) + min_bright_blue); 
        var max_bright_blue3 = ((((sun_altitude - rise_min_bright_blue_alt)/((rise_max_bright_blue_alt-rise_min_bright_blue_alt)/2)) * (max_bright_blue - min_bright_blue)) + min_bright_blue)
        var range_bright_blue = (max_bright_blue3 - min_bright_blue3)
        var bright_blue_int = Math.round((max_bright_blue3 - ((sun_dist/180) * range_bright_blue)) * 254)
      } else {
        var bright_blue_int = Math.round((min_bright_blue) * 254)}

      if (sun_altitude > rise_max_bright_yellow_alt) {bright_yellow_int = Math.round((max_bright_yellow) * 254)} else if (sun_altitude <= rise_max_bright_yellow_alt && sun_altitude > (((rise_max_bright_yellow_alt - rise_min_bright_yellow_alt)/2)+rise_min_bright_yellow_alt)) {
        var min_bright_yellow2 = ((((sun_altitude - rise_min_bright_yellow_alt)/(rise_max_bright_yellow_alt-rise_min_bright_yellow_alt)) * (max_bright_yellow - min_bright_yellow)) + min_bright_yellow); 
        var max_bright_yellow2 = max_bright_yellow
        var range_bright_yellow = (max_bright_yellow2 - min_bright_yellow2)
        var bright_yellow_int = Math.round((max_bright_yellow2 - ((sun_dist/180) * range_bright_yellow)) * 254)} else if (sun_altitude <= (((rise_max_bright_yellow_alt - rise_min_bright_yellow_alt)/2)+rise_min_bright_yellow_alt) && sun_altitude > rise_min_bright_yellow_alt) {
  
        var min_bright_yellow3 = ((((sun_altitude - rise_min_bright_yellow_alt)/(rise_max_bright_yellow_alt-rise_min_bright_yellow_alt)) * (max_bright_yellow - min_bright_yellow)) + min_bright_yellow); 
        var max_bright_yellow3 = ((((sun_altitude - rise_min_bright_yellow_alt)/((rise_max_bright_yellow_alt-rise_min_bright_yellow_alt)/2)) * (max_bright_yellow - min_bright_yellow)) + min_bright_yellow)
    ...
    if (sun_azimuth > 180) {
      if (sun_altitude > set_max_bright_blue_alt) {bright_blue_int = Math.round((max_bright_blue) * 254)} else if (sun_altitude <= set_max_bright_blue_alt && sun_altitude > (((set_max_bright_blue_alt - set_min_bright_blue_alt)/2)+set_min_bright_blue_alt)) {
        var min_bright_blue2 = ((((sun_altitude - set_min_bright_blue_alt)/(set_max_bright_blue_alt-set_min_bright_blue_alt)) * (max_bright_blue - min_bright_blue)) + min_bright_blue); 
        var max_bright_blue2 = max_bright_blue
        var range_bright_blue = (max_bright_blue2 - min_bright_blue2)
        var bright_blue_int = Math.round((max_bright_blue2 - ((sun_dist/180) * range_bright_blue)) * 254)} else if (sun_altitude <= (((set_max_bright_blue_alt - set_min_bright_blue_alt)/2)+set_min_bright_blue_alt) && sun_altitude > set_min_bright_blue_alt) {
    
        var min_bright_blue3 = ((((sun_altitude - set_min_bright_blue_alt)/(set_max_bright_blue_alt-set_min_bright_blue_alt)) * (max_bright_blue - min_bright_blue)) + min_bright_blue); 
        var max_bright_blue3 = ((((sun_altitude - set_min_bright_blue_alt)/((set_max_bright_blue_alt-set_min_bright_blue_alt)/2)) * (max_bright_blue - min_bright_blue)) + min_bright_blue)
        var range_bright_blue = (max_bright_blue3 - min_bright_blue3)
        var bright_blue_int = Math.round((max_bright_blue3 - ((sun_dist/180) * range_bright_blue)) * 254)
      } else {
        var bright_blue_int = Math.round((min_bright_blue) * 254)}
    
      if (sun_altitude > set_max_bright_yellow_alt) {bright_yellow_int = Math.round((max_bright_yellow) * 254)} else if (sun_altitude <= set_max_bright_yellow_alt && sun_altitude > (((set_max_bright_yellow_alt - set_min_bright_yellow_alt)/2)+set_min_bright_yellow_alt)) {
        var min_bright_yellow2 = ((((sun_altitude - set_min_bright_yellow_alt)/(set_max_bright_yellow_alt-set_min_bright_yellow_alt)) * (max_bright_yellow - min_bright_yellow)) + min_bright_yellow); 
        var max_bright_yellow2 = max_bright_yellow
        var range_bright_yellow = (max_bright_yellow2 - min_bright_yellow2)
        var bright_yellow_int = Math.round((max_bright_yellow2 - ((sun_dist/180) * range_bright_yellow)) * 254)} else if (sun_altitude <= (((set_max_bright_yellow_alt - set_min_bright_yellow_alt)/2)+set_min_bright_yellow_alt) && sun_altitude > set_min_bright_yellow_alt) {
      
        var min_bright_yellow3 = ((((sun_altitude - set_min_bright_yellow_alt)/(set_max_bright_yellow_alt-set_min_bright_yellow_alt)) * (max_bright_yellow - min_bright_yellow)) + min_bright_yellow); 
        var max_bright_yellow3 = ((((sun_altitude - set_min_bright_yellow_alt)/((set_max_bright_yellow_alt-set_min_bright_yellow_alt)/2)) * (max_bright_yellow - min_bright_yellow)) + min_bright_yellow)
        var range_bright_yellow = (max_bright_yellow3 - min_bright_yellow3)
        var bright_yellow_int = Math.round((max_bright_yellow3 - ((sun_dist/180) * range_bright_yellow)) * 254)
      } else {
        var bright_yellow_int = Math.round((min_bright_yellow) * 254)}
    ...
    var yellow_x_shifted_blue = ((Math.sqrt((scatdist_x ** 2) + (scatdist_y ** 2))) * (Math.cos(degreestoradians(origang_deg + scatangshift_blue)))) + (white_x)
    var yellow_y_shifted_blue = ((Math.sqrt((scatdist_x ** 2) + (scatdist_y ** 2))) * (Math.sin(degreestoradians(origang_deg + scatangshift_blue)))) + (white_y)

    var blue_x_blue = (white_x - (yellow_x_shifted_blue - white_x))
    var blue_y_blue = (white_y - (yellow_y_shifted_blue - white_y))
