...
def TimeGiver ( #TimeGiver is the main function of the script that takes arguments about rhythm parameters using key-value syntax with defaults as shown below and returns a list of 8 items describing how the lights should look at that moment according to that schedule.
    ...
    max_CCT = float (6500),
    min_CCT = float (2700),
    max_scatdist = float (3000),
    min_scatdist = float (2000),
    max_scatangshift = float (15),
    min_scatangshift = float (0),
    max_bright_yellow = float (1),
    min_bright_yellow = float (0.05),
    max_bright_blue = float (1),
    min_bright_blue = float (0.05),
    ...
    rise_length_CCT = float (1),
    set_length_CCT = float (1),
    rise_length_scatdist = float (1),
    set_length_scatdist = float (1),
    rise_length_scatangshift = float (240),
    set_length_scatangshift = float (240),
    rise_length_bright_yellow = float (45),
    set_length_bright_yellow = float (90),
    rise_length_bright_blue = float (45),
    ...
    rise_scatangshift = float (-1 * ((((hm - wake_time_flt - wake_offset_flt)/rise_length_scatangshift_flt) ** (rise_slope_scatangshift_exp2)) * (max_scatangshift_flt - min_scatangshift_flt) + min_scatangshift_flt) + 15) #scattering angle shift in degrees during wake routine
    set_scatangshift = float (-1 * ((((bed_time_flt - bed_offset_flt - hm)/set_length_scatangshift_flt) ** (set_slope_scatangshift_exp2)) * (max_scatangshift_flt - min_scatangshift_flt) + min_scatangshift_flt) + 15) #scattering angle shift in degrees during bed routine
